...
public class CustomerEditProfileFrame extends JFrame {
    ...
    public CustomerEditProfileFrame(User customer) {
        ...
        JLabel titleLabel = new JLabel("Edit Customer Profile");
        ...
        JLabel allUsersLabel = new JLabel("Customer Profile");
    ...
    private void updateUser() {
        ...
        if (!idToUpdate.equals(customer.getId())) {
        ...
        int age;
        try {
            age = ageStr.isEmpty() ? customer.getAge() : Integer.parseInt(ageStr);
            if (age <= 0 || age > 120) {
        ...
        try {
            ...
            User updatedUser = new Customer(idToUpdate, newName, newPassword, newGender, newEmail, newPhone, newAge);
